...
public class AnonymousTryConvertTests {
    ...
    public void Anonymous_UnknownClosure_TryConvert_FailsAndReturnsAnonymousClosure() {
        ...
        Assert.Multiple(() => {
            ...
            Assert.That(converted.Delegate, Is.EqualTo(unknownClosure.Delegate), "Converted closure delegate should match the original delegate");
            Assert.That(converted.Context, Is.EqualTo(unknownClosure.Context), "Converted closure context should match the original context");
            Assert.That(success, Is.False, "Conversion should fail for unknown closure types");
        });
    }
}