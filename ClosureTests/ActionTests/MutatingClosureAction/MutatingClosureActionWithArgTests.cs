...
public class MutatingClosureActionWithArgTests {
    ...
    public void MutatingClosureActionWithArg_ReceivesContext() {
        ...
        var closure = Closure.Action(context, (ref int ctx, int a) => Assert.That(ctx, Is.EqualTo(expected)));
        closure.Invoke(arg);
    }
    ...
    public void MutatingClosureActionWithArg_ReceivesTupleContext_AndModifiesTestContextValue() {
        ...
        var closure = Closure.Action((testContext, expected), (ref (TestClass testContext, int expected) ctx, int a) => ctx.testContext.Value = ctx.expected);
        closure.Invoke(arg);
        Assert.That(testContext.Value, Is.EqualTo(expected));
    }

    [Test]
    public void MutatingClosureActionWithArg_AddAndRemove_Works() {
        int context = 1;
        int arg = 2;
        int callSum = 0;
    ...
    [Test]
    public void MutatingClosureActionWithArg_Add_MultipleTimes_Works() {
        int context = 2;
        int arg = 3;
        int actionCount = 5;
        int callSum = 0;
    ...
    [Test]
    public void MutatingClosureActionWithArg_Remove_MultipleTimes_Works() {
        int context = 3;
        int arg = 4;
        int actionCount = 5;
        int amountToCall = 2;
    ...
    public void MutatingClosureActionWithArg_ReceivesArg() {
        ...
        var closure = Closure.Action(context, (ref int ctx, int a) => Assert.That(ctx + a, Is.EqualTo(expected)));
        closure.Invoke(arg);
    }
    ...
    [Test]
    public void MutatingClosureActionWithArg_Retain_RetainsModifiedContext() {
        int context = 5;
        int addition = 3;
        int expected = context + addition;
            
        var closure = Closure.Action(context, (ref int ctx, int arg) => ctx += arg, MutatingClosureBehaviour.Retain);
    ...
    [Test]
    public void MutatingClosureActionWithArg_Reset_ResetsModifiedContext() {
        int context = 5;
        int addition = 3;
        int expected = context;
            
        var closure = Closure.Action(context, (ref int ctx, int arg) => ctx += arg, MutatingClosureBehaviour.Reset);
        closure.Invoke(addition);
