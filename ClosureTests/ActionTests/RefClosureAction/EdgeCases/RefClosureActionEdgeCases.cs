...
public class RefClosureActionEdgeCases {
    ...
    public void RefClosureAction_NullContext_Invoke_DoesNotThrow() {
        int? context = null;
        Assert.DoesNotThrow(() => {
            var closure = RefClosure.Action(ref context, (ref int? ctx) => Assert.That(ctx, Is.Null, "Context should be null"));
            closure.Invoke();
    ...
    public void RefClosureAction_NullDelegate_Invoke_DoesNotThrow() {
        ...
        Assert.Throws<NullReferenceException>(() => {
            var closure = RefClosure.Action(ref context, (RefAction<int>)null);
            closure.Invoke();
    ...
    public void RefClosureAction_ExceptionDuringInvocation_Throws() {
        ...
        Assert.Throws<InvalidOperationException>(() => {
            var closure = RefClosure.Action(ref context, (ref int ctx) => throw new InvalidOperationException("Test exception"));
            closure.Invoke();
    ...
    public void RefClosureAction_NullContext_Invoke_SetsValueToOriginalContext() {
        ...
        var closure = RefClosure.Action(ref context, (ref int? ctx) => {
