...
public static class Closure {
    ...
    /// <summary> Creates an <see cref="ActionClosureRef{TContext}"/> with the specified ref context and action. </summary>
    ...
    /// <summary> Creates an <see cref="ActionClosureRef{TContext, TArg}"/> with the specified ref context and action. </summary>
    ...
    /// <summary> Creates a <see cref="RefActionClosureRef{TContext, TArg}"/> with the specified ref context and action. </summary>
    public static RefActionClosureRef<TContext, TArg> CreateRefAction<TContext, TArg>(TContext context, RefAction<TContext, TArg> action) =>
