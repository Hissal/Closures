namespace Closures {
    ...
    /// <summary>
    /// Defines the behavior of a mutating closure after invocation.
    /// </summary>
    public enum MutatingClosureBehaviour {
        /// <summary>
        /// The context value is retained after invocation.
        /// </summary>
        Retain,
        /// <summary>
        /// The context value is reset to its initial state after invocation.
        /// </summary>
        Reset,
    }
